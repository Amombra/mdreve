...
class RegisterSimple extends StatefulWidget {
  @override
  _RegisterSimpleState createState() => _RegisterSimpleState();
...
class _RegisterSimpleState extends State<RegisterSimple> {
